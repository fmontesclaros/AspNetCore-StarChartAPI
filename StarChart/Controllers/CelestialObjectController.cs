...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        public IActionResult Update(int id, CelestialObject celestialObject)
        {
            ...
            if (existingObj == null)
                return NotFound();
            existingObj.Name = celestialObject.Name;
            existingObj.OrbitalPeriod = celestialObject.OrbitalPeriod;
            existingObj.OrbitedObjectId = celestialObject.OrbitedObjectId;
